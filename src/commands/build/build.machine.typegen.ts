...
export interface Typegen0 {
  ...
  internalEvents: {
    ...
    "done.invoke.buildMachine.cleanupFirst:invocation[0]": {
      type: "done.invoke.buildMachine.cleanupFirst:invocation[0]";
      data: unknown;
      __tip: "See the XState TS docs to learn how to strongly type this.";
    };
    ...
    "error.platform.buildMachine.cleanupFirst:invocation[0]": {
      type: "error.platform.buildMachine.cleanupFirst:invocation[0]";
      data: unknown;
    };
